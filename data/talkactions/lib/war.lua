War = {
	...
	mapas = {	
						  [0] = {     {{x=1378,y=2045,z=6},{x=1395,y=2105,z=7}}     },		-- exemplo de apenas um mapa Edron configurado
						  [1] = {     {{x=779,y=2275,z=7},{x=844,y=2319,z=6}}     },
						  [2] = {     {{x=852,y=2068,z=6},{x=807,y=2044,z=7}}     }	
	},
}
