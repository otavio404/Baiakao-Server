_config_npc_shop = {
	...
	items_block = {2160,2152,2148,10558}, -- items que o npc n vai poder vender
...
function getItemType(itemid)
	local slot, slottypes = "", {"helmet", "armor", "legs", "boots", "shield", "sword","wand", "club", "axe", "distance", "ammunition", "ammo"}
