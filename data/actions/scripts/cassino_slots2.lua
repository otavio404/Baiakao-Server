...
local gstrg = 12134 -- Não Mexa, Storage de Controle Item Global.
local gstrg_control = 12135 -- Não Mexa, Storage de Controle Jogo em Execução.
local istrg = {12136, 12137, 12138} -- Não Mexa, Storage de Itens.
local items = {
    [0] = {0},  -- NEUTRO
    [1] = {2182}, -- ID do ITEM 1
    [2] = {2183}, -- ID do ITEM 2
...
-- [[ QUANTIDADE DE ACERTOS  ]] --
local iluck_pos = {x=530, y=69, z=14} -- Posição onde fica a amostra do item da sorte
local pos = {{x=530, y=68, z=14}, {x=532, y=68, z=14}, {x=534, y=68, z=14}} -- Posições onde os itens sorteados aparecerão
