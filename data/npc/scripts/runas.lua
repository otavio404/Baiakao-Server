...
shopModule:addBuyableItem({'firebomb'}, 2305, 50, 1, 'firebomb rune')
shopModule:addBuyableItem({'fire field'}, 2301, 50, 1, 'fire field rune')
shopModule:addBuyableItem({'fire wall'}, 2303, 50, 1, 'fire wall rune')
...
shopModule:addBuyableItem({'energy bomb'}, 2262, 50, 1, 'energy bomb rune')
shopModule:addBuyableItem({'energy wall'}, 2279, 50, 1, 'energy wall rune')
shopModule:addBuyableItem({'energy field'}, 2277, 50, 1, 'energy field rune')
shopModule:addBuyableItem({'sudden death'}, 2268, 350, 1, 'sudden death rune')
shopModule:addBuyableItem({'paralyze'}, 2278, 700, 1, 'paralyze rune')
shopModule:addBuyableItem({'poison bomb'}, 2286, 50, 1, 'poison bomb rune')
shopModule:addBuyableItem({'poison field'}, 2285, 50, 1, 'poison field rune')
shopModule:addBuyableItem({'poison wall'}, 2289, 50, 1, 'poison wall rune')
