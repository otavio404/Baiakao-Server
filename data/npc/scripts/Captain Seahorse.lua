...
local travelNode = keywordHandler:addKeyword({"carlin"}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "Você procura uma passagem para Carlin por " .. (getConfigInfo("freeTravel") and "free?" or "110 gold?")})
	...
	travelNode:addChildKeyword({"no"}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, reset = true, text = "Nós gostaríamos de lhe servir de algum modo."})

local travelNode = keywordHandler:addKeyword({"ab\'dendriel"}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "Você procura uma passagem para Ab\'Dendriel por " .. (getConfigInfo("freeTravel") and "free?" or "70 gold?")})
...
local travelNode = keywordHandler:addKeyword({"thais"}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "Você procura uma passagem para Thais por " .. (getConfigInfo("freeTravel") and "free?" or "160 gold?")})
...
local travelNode = keywordHandler:addKeyword({"port hope"}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "Você procura uma passagem para Port Hope por " .. (getConfigInfo("freeTravel") and "free?" or "150 gold??")})
...
local travelNode = keywordHandler:addKeyword({"ankrahmun"}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "Você procura uma passagem para Ankrahmun por " .. (getConfigInfo("freeTravel") and "free?" or "160 gold?")})
...
local travelNode = keywordHandler:addKeyword({"liberty bay"}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "Você procura uma passagem para Liberty Bay por " .. (getConfigInfo("freeTravel") and "free?" or "170 gold?")})
...
local travelNode = keywordHandler:addKeyword({"cormaya"}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "Você procura uma passagem para Cormaya por " .. (getConfigInfo("freeTravel") and "free?" or "20 gold?")})
...
local travelNode = keywordHandler:addKeyword({"venore"}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "Você procura uma passagem para Venore por " .. (getConfigInfo("freeTravel") and "free?" or "40 gold?")})
...
local travelNode = keywordHandler:addKeyword({"yalahar"}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "Você procura uma passagem para Yalahar por " .. (getConfigInfo("freeTravel") and "free?" or "190 gold coins?")})
